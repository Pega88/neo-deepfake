...
HARDCODED_WALLETNAME = custom_settings.HARDCODED_WALLETNAME
HARDCODED_PASSWORD = custom_settings.HARDCODED_PASSWORD
HARDCODED_CONTRACT_ID = custom_settings.HARDCODED_CONTRACT_ID
HARDCODED_ARGS = custom_settings.HARDCODED_ARGS
ENABLE_AUTO_INVOKE = custom_settings.ENABLE_AUTO_INVOKE
...
class PromptInterface:
    ...
    def do_open(self, arguments):
        ...
        # if item and item == 'custom':
        #     HARDCODED_WALLETNAME = 'walletfile'
        #     HARDCODED_PASSWORD = '1234567890'
        #     HARDCODED_CONTRACT_ID = '0x1d36641faca64ddd0f49af488e543a0f89860690'
        #     HARDCODED_ARGS = [HARDCODED_CONTRACT_ID, "add", "1", "2"]
        ...
        if item and item == 'wallet':
            ...
            if path:
                ...
                password_key = to_aes_key(HARDCODED_PASSWORD)
    ...
    def test_invoke_contract(self, args):
        ...
        if args and len(args) > 0:
            tx, fee, results, num_ops = TestInvokeContract(self.Wallet, args, from_addr=from_addr, invoke_attrs=None, owners=owners)

            # TestInvokeContract(wallet, args, withdrawal_tx=None,
